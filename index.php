    ...
    <body onKeyPress="checkKey(event)">
        ...
        <center>
            <div class="wrap">
                ...
                <input type="text" name="target" id="target" class="field" value="<?php echo isset($_GET['target'])?htmlentities(urldecode($_GET['target'])):"http://"; ?>">

                <br><br>

                <div class="sidebyside">
                    <label for="message">Message (optional)</label><br>
                    <input type="text" name="message" id="message" class="field" value="<?php echo htmlentities(urldecode($_GET['message'])); ?>" style="width: 197px; margin-right: 5px;">
                </div><div class="sidebyside">
                    <label for="rps">RPS</label><br>
                    <input type="text" name="rps" id="rps" class="field" value="<?php echo isset($_GET['rps'])?htmlentities(urldecode($_GET['rps'])):"10"; ?>" maxlength="4" style="width: 40px; text-align: center;">
                </div>
